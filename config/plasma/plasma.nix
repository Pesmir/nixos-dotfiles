{
  programs.plasma = {
    enable = true;
    shortcuts = {
      "ActivityManager"."switch-to-activity-7165fffa-4ccb-48a3-aa46-f27e20194a93" = [ ];
      "ActivityManager"."switch-to-activity-7b3d4788-2852-413d-ac72-3bd50caabfec" = [ ];
    ...
    files = {
      ...
      "kactivitymanagerdrc"."activities"."7165fffa-4ccb-48a3-aa46-f27e20194a93" = "Alt";
      "kactivitymanagerdrc"."activities"."7b3d4788-2852-413d-ac72-3bd50caabfec" = "Default";
      "kactivitymanagerdrc"."activities-icons"."7165fffa-4ccb-48a3-aa46-f27e20194a93" = "activities";
      "kactivitymanagerdrc"."main"."currentActivity" = "7b3d4788-2852-413d-ac72-3bd50caabfec";
      ...
      "kcminputrc"."Libinput.2.7.SynPS/2 Synaptics TouchPad"."PointerAccelerationProfile" = 1;
      ...
      "khotkeysrc"."Data_2_1Triggers0"."Uuid" = "{05a714c8-6884-427c-9835-29b6506f118e}";
      ...
      "khotkeysrc"."Data_2_2Triggers0"."Uuid" = "{b6427556-9022-4159-9424-e639cc180559}";
      ...
      "khotkeysrc"."Data_2_3Triggers0"."Uuid" = "{e7696096-1822-4245-8b4c-8a2270b61361}";
      ...
      "khotkeysrc"."Data_2_4Triggers0"."Uuid" = "{3f9667c2-4f8c-4298-82b0-f8d5779ec847}";
      ...
      "khotkeysrc"."Data_2_5Triggers0"."Uuid" = "{4a8298ea-0099-4544-af63-fc0641c2715e}";
      ...
      "khotkeysrc"."Data_2_6Triggers0"."Uuid" = "{c91d8d6c-d0d5-4530-be13-ba08bea7b50b}";
      ...
      "khotkeysrc"."Data_2_8Triggers0"."Uuid" = "{211ff78d-a9c2-46f2-8c14-424587cf221c}";
      ...
      "kwinrc"."Tiling.117c5326-fae2-5ea0-9435-13ccdf42c006"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling.28f5dac9-3409-5ba4-8efc-eb6ebb51950b"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.57f49666-3334-5096-95ff-a32c688f81f2"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling.5bdd92b2-b95f-554b-a8f8-4491e1fc2efd"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Tiling.641d2bdc-dd0a-5136-8611-50c42d2793fe"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      ...
      "kwinrc"."Tiling.facbb049-26ef-56af-9577-7f586503beed"."tiles" = "{\"layoutDirection\":\"horizontal\",\"tiles\":[{\"width\":0.25},{\"width\":0.5},{\"width\":0.25}]}";
      "kwinrc"."Windows"."FocusPolicy" = "FocusFollowsMouse";
      "kwinrc"."Windows"."NextFocusPrefersMouse" = true;
      "kwinrc"."Xwayland"."Scale" = 1;
      "kxkbrc"."Layout"."DisplayNames" = ",";
      "kxkbrc"."Layout"."LayoutList" = "at,eu";
